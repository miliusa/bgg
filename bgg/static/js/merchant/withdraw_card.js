$(function () {
    ...
    // 手续费
    $.ajax({
        url: _apiUrl + 'public/bgg/index/merch/getfee',
        dataType: 'JSON',
        type: 'GET',
        success: function (resstr) {
            var res = null;
    ...
    function withdraw(price){
        ...
        var data = {
            withdrawtype: 3,
            withdrawtools: 'balance',
            price: price,
        }
        $.ajax({
            url: _apiUrl + 'public/bgg/index/merch/withdraw',
            beforeSend: function (request) {
                request.setRequestHeader("token", getUserToken())
            },
            data: data,
    ...
    $('.default_btn.active').on('tap', function () {
        ...
        $.ajax({
            url: _apiUrl + 'public/bgg/index/merch/isfullbankcard',
            beforeSend: function (request) {
                request.setRequestHeader("token", getUserToken())
            },
            dataType: 'JSON',
