	...
	$.ajax({
		...
		success: function (resstr) {
			...
			if(res.code == 200){
				...
				var statusText = res.data.refundstatus == 2?'已处理':res.data.refundstatus == 1 && res.data.merchrejectrefund == 1?'审核中':res.data.refundstatus == 1 && res.data.merchrejectrefund != 1?'待处理': ''
				var html = ''
